/*
 * @file QQ_GF2EX_Tests.cpp
 * @author Reginald Lybbert
 * @brief Test program for QQ<GF2EX> class for rational numbers and functions
 */
...
//How do I test this for rational functions?  What is the desired behaviour?
  ...
  //addition
  QQ<GF2EX> addend1(a,b);
  QQ<GF2EX> addend2(c,d);
  GF2EX addend3 = a;  
  QQ<GF2EX> sum1,sum2,sum3,sum4,sum5,sum6;
 
  GF2EX expectedNumer1 = a*d + b*c;
  GF2EX expectedDenom1 = b*d;
  GF2EX expectedNumer2 = a + a*b;
  GF2EX expectedDenom2 = b;

  QQ<GF2EX> addResult1(expectedNumer1,expectedDenom1);
  QQ<GF2EX> addResult2(expectedNumer2,expectedDenom2);
  ...
  QQ<GF2EX> addResult3(sum4.getN()*addResult2.getD() + addResult2.getN()*sum4.getD(), sum4.getD()*addResult2.getD());
  QQ<GF2EX> addResult4(a*addResult2.getD() + addResult2.getN(), addResult2.getD());
 ...
 //subtraction
  QQ<GF2EX> addend4(a,b);
  QQ<GF2EX> addend5(c,d);
  GF2EX addend6 = a;  
  QQ<GF2EX> diff1,diff2,diff3,diff4,diff5,diff6;
  ...
  QQ<GF2EX> subResult1(expectedNumer1,expectedDenom1);
  QQ<GF2EX> subResult2(expectedNumer2,expectedDenom2);
  ...
  QQ<GF2EX> subResult5(subResult2.getN() - a*subResult2.getD(),subResult2.getD()); 
  QQ<GF2EX> subResult6(-subResult2.getN()*diff4.getD() - diff4.getN()*subResult2.getD(), diff4.getD()*subResult2.getD());
  ...
  //multiplication
  QQ<GF2EX> factor1(a,b);
  QQ<GF2EX> factor2(c,d);
  GF2EX factor3 = a;  
  QQ<GF2EX> prod1,prod2,prod3,prod4,prod5,prod6;
  ...
  QQ<GF2EX> mulResult1(expectedNumer1,expectedDenom1);
  QQ<GF2EX> mulResult2(expectedNumer2,expectedDenom2);
  ...
  QQ<GF2EX> mulResult5(a*a*a,b);
  QQ<GF2EX> mulResult6(a*a*a*c,b*b*d);
  if(prod5 == mulResult5){
     cout << "QQ *= T: Success" << endl;
  }else{
     cout << "QQ *= T: Failure" << endl;
 ...
 //division
  QQ<GF2EX> factor4(a,b);
  QQ<GF2EX> factor5(c,d);
  GF2EX factor6 = a;  
  QQ<GF2EX> quot1,quot2,quot3,quot4,quot5,quot6;

  QQ<GF2EX> divResult1(a*d,b*c);
  QQ<GF2EX> divResult2(b);
  divResult2.invert();
  QQ<GF2EX> divResult3(b);
  ...
  QQ<GF2EX> divResult5(a*b);
  divResult5.invert();
  QQ<GF2EX> divResult6(b*b*c,a*d);
  ...
  QQ<GF2EX> toSquare(a,b);
  QQ<GF2EX> square, cubed;

  sqr(square,toSquare);
  cube(cubed, toSquare);

  QQ<GF2EX> expectedSquare(a*a,b*b);
  QQ<GF2EX> expectedCube(a*a*a,b*b*b);
