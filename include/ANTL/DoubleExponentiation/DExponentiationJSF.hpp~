...
namespace ANTL
{
   ...
   */
  template < class T >
  class DExponentiationJSF : public DExponentiation<T> 
  {
...
#include "../../../src/DExponentiation/DExponentiationJSF_impl.hpp"

#endif // DEXPONENTIATION_JSF_H
