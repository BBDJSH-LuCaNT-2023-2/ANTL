...
template <>
void 
qo_nudupl<long>::init(const long & Din, const long & hin, long gin)
{
  qo_square<long>::init(Din,hin,0);
...
template <>
void
qo_nudupl<long>::square(QuadraticIdealBase<long> & C, const QuadraticIdealBase<long> & A)
{
