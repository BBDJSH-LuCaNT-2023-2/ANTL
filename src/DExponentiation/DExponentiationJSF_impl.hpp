/**
 * @file DExponentiationJSF_impl.hpp
 * @author Michael Jacobson/Reginald Lybbert
 * @brief generic implementation of templated methods from DExponentiationJSF class
 */
...
template < class T >
void 
DExponentiationJSF<T>::initialize(const T &A, const T&B, const ZZ &m, const ZZ & n)
{
...
template < class T > 
void 
DExponentiationJSF<T>::power (T &C, const T &A, const T &B, const ZZ & m, const ZZ & n)
{
