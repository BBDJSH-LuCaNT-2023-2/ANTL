/**
 * @file L_function_longlong.cpp
 * @author Leonard Nooy
 * @version $Header$
 *
 * This file contains the longlong specialization for the L_function class.
 */
...
namespace ANTL
{
  ...
  *******************************************************************************************/
  ...
  /*
   * Function: L_function<longlong>::init
  ...
  *******************************************************************************************/
   ...
   * Inputs:      L_function<longlong>& lfunc - the L-function to compute
   ...
   *              Generic template version by Rennie deGraaf - computes using the precision of
   *              floating-point type TYPE.  This function is a friend of the L_function class.
   * Inputs:      L_function<long long>& lfunc - the L-function to compute
   *              long terms - The number of terms to use in the summation.
  ...
  /*
   * Function: L_function<long long>::approximateL0_ImaginaryNumberField
   * Description: This function is simply a wrapper for the calculate_optimal_n and approximateL0(long n)
   * Inputs: double acc - The required accuracy
   * Outputs: CC - The result of the calculation
   */
  ...
  *******************************************************************************************/
  ...
  template <class TYPE> RR approximateL1_Quartic_impl(L_function<long long>& lfunc, double acc)
  {
    ...
    Epref = to<RR>(lfunc.Delta) / (to_RR(2) * lfunc.PI * lfunc.PI);
    E = to<TYPE>(0.8);
#ifdef EXTRA
   ...
   *              represented by a long long, and thus has no restriction.
  ...
  ******************************************************************************************/
  ...
  template <>
  RR L_function < long long >::approximateL0_RealNumberField_table(double acc)
  {
    RR L0;
  ...
  template <>
  RR L_function < long long >::approximateL0_ImaginaryNumberField_table(double acc)
  {
    RR L0;
  ...
  /*
   * Function: L_function<long long>::approximateL1_table
   * Description: This function calculates the value of L1 using eric bach's method
   *              of truncated euler terms. It used doubles for internal calculations
