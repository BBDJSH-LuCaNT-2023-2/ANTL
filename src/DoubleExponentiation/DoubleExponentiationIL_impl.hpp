...
template < class T >
void 
DoubleExponentiationIL<T>::initialize(const T &A, const T&B, const ZZ &m, const ZZ & n, const short w0, const short w1)
{
...
template < class T > 
void 
DoubleExponentiationIL<T>::power (T &C, const T &A, const T &B, const ZZ & m, const ZZ & n)
{
