...
template < class T >
void 
DoubleExponentiationJSF<T>::initialize(const T &A, const T&B, const ZZ &m, const ZZ & n)
{
...
template < class T > 
void 
DoubleExponentiationJSF<T>::power (T &C, const T &A, const T &B, const ZZ & m, const ZZ & n)
{
