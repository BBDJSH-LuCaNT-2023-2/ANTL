...
template < class T >
void
DoubleExponentiationHBTJSF<T>::readPrecomps(T &C, short mDigit, short nDigit)
{
...
template < class T >
void 
DoubleExponentiationHBTJSF<T>::initializeBase(const T &A, const T&B)
{
...
template < class T >
void
DoubleExponentiationHBTJSF<T>::initializeExponent(const ZZ &m, const ZZ &n)
{
  initM = m;
  initN = n;
...
template < class T > 
void 
DoubleExponentiationHBTJSF<T>::power (T &C, const T &A, const T &B, const ZZ & m, const ZZ & n)
{
